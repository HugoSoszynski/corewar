...
char		**set_cmd_part2(char **cmd)
{
  ...
  cmd[27] = my_strdup("d/i,r");
  cmd[28] = my_strdup("lldi");
  cmd[29] = my_strdup("r/d/i,r/d,r");
...
char		**set_cmd_part1()
{
  ...
  cmd[1] = my_strdup("d");
  cmd[2] = my_strdup("ld");
  cmd[3] = my_strdup("d/i,r");
  cmd[4] = my_strdup("st");
  cmd[5] = my_strdup("r,d/r");
  cmd[6] = my_strdup("add");
  cmd[7] = my_strdup("r,r,r");
  cmd[8] = my_strdup("sub");
  cmd[9] = my_strdup("r,r,r");
  cmd[10] = my_strdup("and");
  cmd[11] = my_strdup("r/d/i,r/d/i,r");
  cmd[12] = my_strdup("or");
  cmd[13] = my_strdup("r/d/i,r/d/i,r");
  cmd[14] = my_strdup("xor");
  cmd[15] = my_strdup("r/d/i,r/d/i,r");
  cmd[16] = my_strdup("zjmp");
  cmd[17] = my_strdup("d");
  cmd[18] = my_strdup("ldi");
  cmd[19] = my_strdup("r/d/i,r/d,r");
  cmd[20] = my_strdup("sti");
  cmd[21] = my_strdup("r,r/d/i,r/d");
